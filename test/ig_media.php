...
function shortcode_to_mediaid($shortcode){
	...
	if (filter_var($shortcode, FILTER_URL)!==NULL) {
...
$shortcode = 'BweM9YChKYYNpdkOsDo5ytPVdJEetIr3p_7CZ00';
$shortcode = 'BwzfDN6gKuW';
$shortcode = 'https://www.instagram.com/stories/highlights/18045278701013902/';


$mediaId = shortcode_to_mediaid($shortcode);
$mediaId = '18045278701013902';
print_r($mediaId);
