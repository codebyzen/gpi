...
<html lang="en">
	<head>
		...
		<!-- Bootstrap core CSS -->
		<link href="<?php echo $config->get('assetsurl'); ?>/bootstrap-4.3.1-dist/css/bootstrap.min.css" rel="stylesheet">
		...
		<script src="<?php echo $config->get('assetsurl'); ?>/jQuery/jquery-3.4.1.min.js"></script> 
